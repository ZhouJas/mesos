...
Try<Isolator*> Cgroups2IsolatorProcess::create(
  const Flags& flags, DeviceManager* deviceManager)
{
  ...
  hashmap<
    string,
    Try<Owned<ControllerProcess>> (*)(const Flags&, DeviceManager*)>
